...
public class Constants {
    ...
    public static final String APOD_URL = "https://api.nasa.gov/planetary/apod?api_key=ZAHIwPnrLy9TdLDLe3cPLVYau4trxcAXGI54dAhJ";

    public static final String EPIC_URL = "https://api.nasa.gov/EPIC/api/natural/images?api_key=ZAHIwPnrLy9TdLDLe3cPLVYau4trxcAXGI54dAhJ";
